...
#------------------------------------------------------------------------
# INITIAL QC
echo "Making a local copy of the report file"
...
## SJN TODO: NEW README AT END OF RUN!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
#------------------------------------------------------------------------
# not being done any more 
#------------------------------------------------------------------------


#------------------------------------------------------------------------
# move the files that will go into iRODS into a separate directory
#------------------------------------------------------------------------
mkdir pipeline_out
mv *Opticall_UA.bed pipeline_out/
mv *Opticall_UA.bim pipeline_out/
mv *Opticall_UA.fam pipeline_out/

mv  *Zcalls_UA.bed pipeline_out/
mv  *Zcalls_UA.bim pipeline_out/
mv  *Zcalls_UA.fam pipeline_out/

mv exome_chip.workflow.sjn.sh pipeline_out/
